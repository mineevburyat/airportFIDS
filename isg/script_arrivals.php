...
if ($status1=='Прибыл') { $status1='<font color=#090>Прибыл</font>'; } else if ($status1=='Задержка') { $status1='<font color=#C00>Задержка</font>'; } else if ($status1=='Ожидается') { $status1='<font color=#036>Ожидается</font>'; } else if ($status1=='Отменен') { $status1='<font color=#C00>Отменен</font>'; };
if ($status2=='Прибыл') { $status2='<font color=#090>Прибыл</font>'; } else if ($status2=='Задержка') { $status2='<font color=#C00>Задержка</font>'; } else if ($status2=='Ожидается') { $status2='<font color=#036>Ожидается</font>'; } else if ($status2=='Отменен') { $status2='<font color=#C00>Отменен</font>'; };
if ($status3=='Прибыл') { $status3='<font color=#090>Прибыл</font>'; } else if ($status3=='Задержка') { $status3='<font color=#C00>Задержка</font>'; } else if ($status3=='Ожидается') { $status3='<font color=#036>Ожидается</font>'; } else if ($status3=='Отменен') { $status3='<font color=#C00>Отменен</font>'; };
if ($status4=='Прибыл') { $status4='<font color=#090>Прибыл</font>'; } else if ($status4=='Задержка') { $status4='<font color=#C00>Задержка</font>'; } else if ($status4=='Ожидается') { $status4='<font color=#036>Ожидается</font>'; } else if ($status4=='Отменен') { $status4='<font color=#C00>Отменен</font>'; };
if ($status5=='Прибыл') { $status5='<font color=#090>Прибыл</font>'; } else if ($status5=='Задержка') { $status5='<font color=#C00>Задержка</font>'; } else if ($status5=='Ожидается') { $status5='<font color=#036>Ожидается</font>'; } else if ($status5=='Отменен') { $status5='<font color=#C00>Отменен</font>'; };
if ($status6=='Прибыл') { $status6='<font color=#090>Прибыл</font>'; } else if ($status6=='Задержка') { $status6='<font color=#C00>Задержка</font>'; } else if ($status6=='Ожидается') { $status6='<font color=#036>Ожидается</font>'; } else if ($status6=='Отменен') { $status6='<font color=#C00>Отменен</font>'; };
if ($status7=='Прибыл') { $status7='<font color=#090>Прибыл</font>'; } else if ($status7=='Задержка') { $status7='<font color=#C00>Задержка</font>'; } else if ($status7=='Ожидается') { $status7='<font color=#036>Ожидается</font>'; } else if ($status7=='Отменен') { $status7='<font color=#C00>Отменен</font>'; };
if ($status8=='Прибыл') { $status8='<font color=#090>Прибыл</font>'; } else if ($status8=='Задержка') { $status8='<font color=#C00>Задержка</font>'; } else if ($status8=='Ожидается') { $status8='<font color=#036>Ожидается</font>'; } else if ($status8=='Отменен') { $status8='<font color=#C00>Отменен</font>'; };
if ($status9=='Прибыл') { $status9='<font color=#090>Прибыл</font>'; } else if ($status9=='Задержка') { $status9='<font color=#C00>Задержка</font>'; } else if ($status9=='Ожидается') { $status9='<font color=#036>Ожидается</font>'; } else if ($status9=='Отменен') { $status9='<font color=#C00>Отменен</font>'; };
if ($status10=='Прибыл') { $status10='<font color=#090>Прибыл</font>'; } else if ($status10=='Задержка') { $status10='<font color=#C00>Задержка</font>'; } else if ($status10=='Ожидается') { $status10='<font color=#036>Ожидается</font>'; } else if ($status10=='Отменен') { $status10='<font color=#C00>Отменен</font>'; };
if ($status11=='Прибыл') { $status11='<font color=#090>Прибыл</font>'; } else if ($status11=='Задержка') { $status11='<font color=#C00>Задержка</font>'; } else if ($status11=='Ожидается') { $status11='<font color=#036>Ожидается</font>'; } else if ($status11=='Отменен') { $status11='<font color=#C00>Отменен</font>'; };
if ($status12=='Прибыл') { $status12='<font color=#090>Прибыл</font>'; } else if ($status12=='Задержка') { $status12='<font color=#C00>Задержка</font>'; } else if ($status12=='Ожидается') { $status12='<font color=#036>Ожидается</font>'; } else if ($status12=='Отменен') { $status12='<font color=#C00>Отменен</font>'; };
if ($status13=='Прибыл') { $status13='<font color=#090>Прибыл</font>'; } else if ($status13=='Задержка') { $status13='<font color=#C00>Задержка</font>'; } else if ($status13=='Ожидается') { $status13='<font color=#036>Ожидается</font>'; } else if ($status13=='Отменен') { $status13='<font color=#C00>Отменен</font>'; };
if ($status14=='Прибыл') { $status14='<font color=#090>Прибыл</font>'; } else if ($status14=='Задержка') { $status14='<font color=#C00>Задержка</font>'; } else if ($status14=='Ожидается') { $status14='<font color=#036>Ожидается</font>'; } else if ($status14=='Отменен') { $status14='<font color=#C00>Отменен</font>'; };
if ($status15=='Прибыл') { $status15='<font color=#090>Прибыл</font>'; } else if ($status15=='Задержка') { $status15='<font color=#C00>Задержка</font>'; } else if ($status15=='Ожидается') { $status15='<font color=#036>Ожидается</font>'; } else if ($status15=='Отменен') { $status15='<font color=#C00>Отменен</font>'; };
if ($status16=='Прибыл') { $status16='<font color=#090>Прибыл</font>'; } else if ($status16=='Задержка') { $status16='<font color=#C00>Задержка</font>'; } else if ($status16=='Ожидается') { $status16='<font color=#036>Ожидается</font>'; } else if ($status16=='Отменен') { $status16='<font color=#C00>Отменен</font>'; };
...
if (!empty($ftp2)) {
	...
	if (ftp_login($ftp2, 'airport_upload', '7xXS2VZA')) { // авторизуемся ShoaCZIf  //'gpdemo_airport', 'HYma4VQS'
		...
		if (ftp_chdir($ftp2, '//')) { // меняем текущую директорию на pub
			...
			// пытаемся положить файл test.txt в директорию pub на FTP
			if (!ftp_put($ftp2, 'bdc_arrivals.php', 'bdc_arrivals.php', FTP_ASCII)) {
				echo 'Cannot put your file to FTP';
			} else {
