...
<TABLE BORDER >
        <TR class="style1">
            <TD COLSPAN=2 width="80%" height="115px">
				<h20><b>Стойка регистрации <?php echo $nst?></b></h20><br>
				<h21>Check-in</h21>
			</TD>
            <TD width="35%">
		...
		<TR class="style2">
            <TD ROWSPAN=2 height="308px" width="410px">
				<center><img src="../../img/logo/<?php echo "$logo" ?>.jpg" width="470px" height="200px" style="border-radius: 25px;"></center>
			</TD> 
