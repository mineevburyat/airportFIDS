...
class Menu {
  ...
  function Menu($dataMenu) {
    ...
    $this->_display_image_level = (!empty($dataMenu["display_image_level"]))?$dataMenu["display_image_level"]:0;

		$this->_display_image_on_top_menu = (!empty($dataMenu["display_image_on_top_menu"]))?$dataMenu["display_image_on_top_menu"]:0;
		$this->_display_image_with_text_on_top_menu = (!empty($dataMenu["display_image_with_text_on_top_menu"]))?$dataMenu["display_image_with_text_on_top_menu"]:0;
		$this->_image_position_on_top_menu = (!empty($dataMenu["image_position_on_top_menu"]))?$dataMenu["image_position_on_top_menu"]:0;
