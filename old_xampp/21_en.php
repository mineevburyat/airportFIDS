...
<html>
<head>
  <META HTTP-EQUIV="refresh" CONTENT='<?php echo $tim ?>;URL=<?php echo $st ?>_en.php'>
...
<body background='logo/fon21.jpg'>
<div class="st"><center><h11>CHECK-IN № 1</h11></center></div>
<div class="logo"><center><br><br><img src="logo/<?php echo "$l" ?>" weight="432px"></img></center></div>
