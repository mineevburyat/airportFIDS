...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=1");
$fre = mysql_fetch_array($qre);
$reis1 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis1'");
$fp = mysql_fetch_array($qp);
$punkt1 = $fp['otprav'];

// Время 
$qvv = mysql_query ("select time from reis where reis='$reis1'");
$fvv = mysql_fetch_array($qvv);
$time1 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis1'");
$fvv = mysql_fetch_array($qvv);
$status1 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis1'");
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=2");
$fre = mysql_fetch_array($qre);
$reis2 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis2'");
$fp = mysql_fetch_array($qp);
$punkt2 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis2'");
$fvv = mysql_fetch_array($qvv);
$time2 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis2'");
$fvv = mysql_fetch_array($qvv);
$status2 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis2'");
$fr = mysql_fetch_array($pr);
$prim2 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=3");
$fre = mysql_fetch_array($qre);
$reis3 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis3'");
$fp = mysql_fetch_array($qp);
$punkt3 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis3'");
$fvv = mysql_fetch_array($qvv);
$time3 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis3'");
$fvv = mysql_fetch_array($qvv);
$status3 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis3'");
$fr = mysql_fetch_array($pr);
$prim3 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=4");
$fre = mysql_fetch_array($qre);
$reis4 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis4'");
$fp = mysql_fetch_array($qp);
$punkt4 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis4'");
$fvv = mysql_fetch_array($qvv);
$time4 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis4'");
$fvv = mysql_fetch_array($qvv);
$status4 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis4'");
$fr = mysql_fetch_array($pr);
$prim4 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=5");
$fre = mysql_fetch_array($qre);
$reis5 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis5'");
$fp = mysql_fetch_array($qp);
$punkt5 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis5'");
$fvv = mysql_fetch_array($qvv);
$time5 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis5'");
$fvv = mysql_fetch_array($qvv);
$status5 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis5'");
$fr = mysql_fetch_array($pr);
$prim5 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=6");
$fre = mysql_fetch_array($qre);
$reis6 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis6'");
$fp = mysql_fetch_array($qp);
$punkt6 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis6'");
$fvv = mysql_fetch_array($qvv);
$time6 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis6'");
$fvv = mysql_fetch_array($qvv);
$status6 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis6'");
$fr = mysql_fetch_array($pr);
$prim6 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=7");
$fre = mysql_fetch_array($qre);
$reis7 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis7'");
$fp = mysql_fetch_array($qp);
$punkt7 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis7'");
$fvv = mysql_fetch_array($qvv);
$time7 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis7'");
$fvv = mysql_fetch_array($qvv);
$status7 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis7'");
$fr = mysql_fetch_array($pr);
$prim7 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=8");
$fre = mysql_fetch_array($qre);
$reis8 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis8'");
$fp = mysql_fetch_array($qp);
$punkt8 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis8'");
$fvv = mysql_fetch_array($qvv);
$time8 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis8'");
$fvv = mysql_fetch_array($qvv);
$status8 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis8'");
$fr = mysql_fetch_array($pr);
$prim8 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=9");
$fre = mysql_fetch_array($qre);
$reis9 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis9'");
$fp = mysql_fetch_array($qp);
$punkt9 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis9'");
$fvv = mysql_fetch_array($qvv);
$time9 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis9'");
$fvv = mysql_fetch_array($qvv);
$status9 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis9'");
$fr = mysql_fetch_array($pr);
$prim9 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=10");
$fre = mysql_fetch_array($qre);
$reis10 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis10'");
$fp = mysql_fetch_array($qp);
$punkt10 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis10'");
$fvv = mysql_fetch_array($qvv);
$time10 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis10'");
$fvv = mysql_fetch_array($qvv);
$status10 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis10'");
$fr = mysql_fetch_array($pr);
$prim10 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=11");
$fre = mysql_fetch_array($qre);
$reis11 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis11'");
$fp = mysql_fetch_array($qp);
$punkt11 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis11'");
$fvv = mysql_fetch_array($qvv);
$time11 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis11'");
$fvv = mysql_fetch_array($qvv);
$status11 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis11'");
$fr = mysql_fetch_array($pr);
$prim11 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=12");
$fre = mysql_fetch_array($qre);
$reis12 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis12'");
$fp = mysql_fetch_array($qp);
$punkt12 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis12'");
$fvv = mysql_fetch_array($qvv);
$time12 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis12'");
$fvv = mysql_fetch_array($qvv);
$status12 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis12'");
$fr = mysql_fetch_array($pr);
$prim12 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=13");
$fre = mysql_fetch_array($qre);
$reis13 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis13'");
$fp = mysql_fetch_array($qp);
$punkt13 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis13'");
$fvv = mysql_fetch_array($qvv);
$time13 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis13'");
$fvv = mysql_fetch_array($qvv);
$status13 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis13'");
$fr = mysql_fetch_array($pr);
$prim13 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=14");
$fre = mysql_fetch_array($qre);
$reis14 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis14'");
$fp = mysql_fetch_array($qp);
$punkt14 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis14'");
$fvv = mysql_fetch_array($qvv);
$time14 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis14'");
$fvv = mysql_fetch_array($qvv);
$status14 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis14'");
$fr = mysql_fetch_array($pr);
$prim14 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=15");
$fre = mysql_fetch_array($qre);
$reis15 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis15'");
$fp = mysql_fetch_array($qp);
$punkt15 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis15'");
$fvv = mysql_fetch_array($qvv);
$time15 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis15'");
$fvv = mysql_fetch_array($qvv);
$status15 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis15'");
$fr = mysql_fetch_array($pr);
$prim15 = $fr['primech'];
// Код
...
// Номер рейса
$qre = mysql_query ("select reis from arrivals where nst=16");
$fre = mysql_fetch_array($qre);
$reis16 = $fre['reis'];
// Пункт отправления
$qp = mysql_query ("select otprav from reis where reis='$reis16'");
$fp = mysql_fetch_array($qp);
$punkt16 = $fp['otprav'];
// Время 
$qvv = mysql_query ("select time from reis where reis='$reis16'");
$fvv = mysql_fetch_array($qvv);
$time16 = $fvv['time'];
// Статус 
$qvv = mysql_query ("select status from reis where reis='$reis16'");
$fvv = mysql_fetch_array($qvv);
$status16 = $fvv['status'];
// Примечание
$pr = mysql_query ("select primech from reis where reis='$reis16'");
$fr = mysql_fetch_array($pr);
$prim16 = $fr['primech'];
// Код
...
<body>
<center><font size=5 color="#555"><b>Прибытие</b></font></center><br>
<FORM id="rowEditForm" ACTION="script_arrivals.php" method="POST">
...
<td>
<input style="width: 75px" id="time1" type="time" name="time1" class="POST" value="<?php echo "$time1" ?>"/>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res1();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
</td></tr>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time2" type="time" name="time2" class="POST" value="<?php echo "$time2" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res2();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time3" type="time" name="time3" class="POST" value="<?php echo "$time3" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res3();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time4" type="time" name="time4" class="POST" value="<?php echo "$time4" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res4();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time5" type="time" name="time5" class="POST" value="<?php echo "$time5" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res5();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time6" type="time" name="time6" class="POST" value="<?php echo "$time6" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res6();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time7" type="time" name="time7" class="POST" value="<?php echo "$time7" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res7();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time8" type="time" name="time8" class="POST" value="<?php echo "$time8" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res8();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time9" type="time" name="time9" class="POST" value="<?php echo "$time9" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res9();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time10" type="time" name="time10" class="POST" value="<?php echo "$time10" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res10();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time11" type="time" name="time11" class="POST" value="<?php echo "$time11" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res11();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time12" type="time" name="time12" class="POST" value="<?php echo "$time12" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res12();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time13" type="time" name="time13" class="POST" value="<?php echo "$time13" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res13();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time14" type="time" name="time14" class="POST" value="<?php echo "$time14" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res14();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time15" type="time" name="time15" class="POST" value="<?php echo "$time15" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res15();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
<tr><td style="background: #eee";>
...
<td>
<input style="width: 75px" id="time16" type="time" name="time16" class="POST" value="<?php echo "$time16" ?>"/>
</td>
<td>
...
<td>
<center><input title='Очистить строку' type="image" src="../img/del.gif" OnClick="Res16();Forma1.submit();" onmouseover="this.width=16;this.height=16" onmouseout="this.width=10;this.height=10">  </center>
</td></tr>
</table>
