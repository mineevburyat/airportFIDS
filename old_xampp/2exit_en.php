...
$qre = mysql_query ("select reis from `exit2` where st=1");
$fre = mysql_fetch_array($qre);
$re1 = $fre['reis'];

$qvv = mysql_query ("select vp1 from `exit2` where st=1");
$fvv = mysql_fetch_array($qvv);
$v1 = $fvv['vp1'];
$qvv = mysql_query ("select vp2 from `exit2` where st=1");
$fvv = mysql_fetch_array($qvv);
$v2 = $fvv['vp2'];

$qvv = mysql_query ("select vp3 from `exit2` where st=1");
$fvv = mysql_fetch_array($qvv);
$v3 = $fvv['vp3'];
$qvv = mysql_query ("select vp4 from `exit2` where st=1");
$fvv = mysql_fetch_array($qvv);
$v4 = $fvv['vp4'];
...
<html>
<head>
  <META HTTP-EQUIV="refresh" CONTENT="38;URL=2exit.php"> 
...
<div class="st"><h11><b></b><h11></div>
<div class="st2"><h16><b>GATE NO.2<b><h16></div>
<br>
<br>
<div class="st3"><center><h16><b>ON FLIGHT<b><h16><br><h21><?php echo "$p1" ?><b></h21><br/>
...
<TABLE border=0 style="margin-top: 30%;"  WIDTH=1000>
    <TR>
      <TD  WIDTH=500><center><h13><b>LANDING BEGINNING</b></h13></center></TD>
	  <TD  WIDTH=480><center><h13><b>COMPLETION OF LANDING</b></h13></center></TD>
    </TR>
</TABLE>
<h18>5545456</h18>
<TABLE style="margin-left: 1%; margin-top: 0%;" border=0>
  ...
  <div class="bg"><marquee scrollamount="3" scrolldelay="10" style="color:#FF8C00; font-family:ARIAL; font-size:40px;  margin-top: 2%; width: 1024px; "><b> Prepare please, the ticket and the passport.</b></marquee></div>
