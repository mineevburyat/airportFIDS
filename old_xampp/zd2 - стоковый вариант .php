...
<TABLE style="margin-left: 1%;" border=0>
  ...
  <TABLE border=0><TR><TD BGCOLOR="black"><h14><b style="color:black;">пусто</b></h14></TD></TR></TABLE>
  <?php } ?>
  <div class="bg"><marquee sc2rollamount="3" sc2rolldelay="10" style="color:#FF8C00; font-family:ARIAL; font-size:40px;  margin-top: 2%; width: 1024px; "><b> Приготовьте пожалуйста, билет и паспорт.<b style="color:black;">555555555555555555555555555555555555555555555555</b>Prepare please, the ticket and the passport.</b></marquee></div>
